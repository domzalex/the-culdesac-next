...
export default function Search({ text, func, currentUser }: SearchProps) {
    ...
    return (
        <div className='w-full h-16 bg-white border-b flex items-center justify-between px-6 sm:px-3'>
            <div className='flex gap-3 items-center sm:justify-between sm:w-full'>
